import{_ as e,c as s,o,d as t}from"./app.0fdc3d94.js";const h=JSON.parse('{"title":"ES6 常用知识","description":"","frontmatter":{},"headers":[{"level":3,"title":"注意点(viteprss 和 vuepress  的变化点)","slug":"注意点-viteprss-和-vuepress-的变化点","link":"#注意点-viteprss-和-vuepress-的变化点","children":[]}],"relativePath":"study/vitepress/index.md"}'),c={name:"study/vitepress/index.md"},a=t(`<h3 id="注意点-viteprss-和-vuepress-的变化点" tabindex="-1">注意点(viteprss 和 vuepress 的变化点) <a class="header-anchor" href="#注意点-viteprss-和-vuepress-的变化点" aria-hidden="true">#</a></h3><pre><code>调试的端口和主机名
