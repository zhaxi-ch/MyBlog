import{_ as s,c as n,o as a,d as l}from"./app.6940013b.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"日常排查数据库的命令 -Sql server 篇","slug":"日常排查数据库的命令-sql-server-篇","link":"#日常排查数据库的命令-sql-server-篇","children":[{"level":3,"title":"常用命令","slug":"常用命令","link":"#常用命令","children":[]},{"level":3,"title":"查询重复的INDEX","slug":"查询重复的index","link":"#查询重复的index","children":[]}]},{"level":2,"title":"检查没有索引的表","slug":"检查没有索引的表","link":"#检查没有索引的表","children":[]},{"level":2,"title":"Mysql 篇","slug":"mysql-篇","link":"#mysql-篇","children":[]}],"relativePath":"yunwei/sql/index.md"}'),p={name:"yunwei/sql/index.md"},o=l(`<h2 id="日常排查数据库的命令-sql-server-篇" tabindex="-1">日常排查数据库的命令 -Sql server 篇 <a class="header-anchor" href="#日常排查数据库的命令-sql-server-篇" aria-hidden="true">#</a></h2><h3 id="常用命令" tabindex="-1">常用命令 <a class="header-anchor" href="#常用命令" aria-hidden="true">#</a></h3><div class="language-SQL"><button title="Copy Code" class="copy"></button><span class="lang">SQL</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;">-- 逻辑读写合计排名前十</span></span>
...
<span class="line"><span style="color:#F78C6C;">DROP</span><span style="color:#A6ACCD;"> </span><span style="color:#F78C6C;">TABLE</span><span style="color:#A6ACCD;"> #temp</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h2 id="mysql-篇" tabindex="-1">Mysql 篇 <a class="header-anchor" href="#mysql-篇" aria-hidden="true">#</a></h2><ul><li>9.1.0 主键 超键 候选键 外键 9.1.1 数据库事务的四个特性及含义 9.1.2 视图的作用，视图可以更改么？ 9.1.3 drop,delete与truncate的区别 9.1.4 索引的工作原理及其种类 9.1.5 连接的种类 9.1.6 数据库范式 9.1.7 数据库优化的思路 9.1.8 存储过程与触发器的区别</li></ul>`,9),e=[o];function c(C,t,r,y,A,D){return a(),n("div",null,e)}const E=s(p,[["render",c]]);export{F as __pageData,E as default};
